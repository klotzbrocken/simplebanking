...
- **Die Zeile unter dem Kontostand blieb beim ersten Start leer** — „noch offen“ und „verfügbar bis“ wurden nur berechnet, wenn das Flyout geöffnet wurde. Wer direkt in die Umsatzliste ging, sah gar nichts, bis irgendwann ein Abruf durchlief. Die Berechnung läuft jetzt auch beim Entsperren und beim Öffnen der Umsatzliste — aus dem lokalen Zwischenspeicher, ohne Abruf bei der Bank.
- **Wasser-Effekt zog im Dunkelmodus eine zweite Kontur hinter den Kontostand** — die Verschiebung durfte über den Rand des Inhalts hinaus abtasten, und die Notlösung dagegen entschied pro Bildpunkt zwischen Original und verschobenem Wert, was an den weichen Kanten der Schrift als Doppelbild sichtbar wurde. Die Abtastung bleibt jetzt innerhalb des Inhalts — damit entfallen sowohl das Doppelbild als auch das kurze schwarze Aufblitzen entlang der Welle.
