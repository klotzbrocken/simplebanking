...
struct BankingTools {
    ...
    /// leisten kann. Der wirksamere Teil ist struktureller: Der Server ist ausschließlich
    /// lesend. Es gibt kein Werkzeug, mit dem eine erfolgreiche Einflussnahme Geld
    /// bewegen oder auch nur einen Entwurf anlegen könnte.
